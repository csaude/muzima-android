...
package mz.org.csaude.muzimamobile.adapters.media;
...
public class MediaRecyclerViewAdapter extends RecyclerView.Adapter<MediaRecyclerViewAdapter.ViewHolder> {
    ...
    private void startMediaDisplayActivity(Media media) {
        ...
        if(!file.exists()){
            ...
            String recentMedia = MuzimaPreferences.getStringPreference(context, context.getResources().getString(R.string.preference_recently_viewed_media), mz.org.csaude.muzimamobile.utils.StringUtils.EMPTY);
            if(!mz.org.csaude.muzimamobile.utils.StringUtils.isEmpty(recentMedia)) {
