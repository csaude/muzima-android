...
package mz.org.csaude.muzimamobile;
...
import mz.org.csaude.muzimamobile.controller.AppReleaseController;
...
import mz.org.csaude.muzimamobile.controller.FCMTokenController;
...
import mz.org.csaude.muzimamobile.controller.MinimumSupportedAppVersionController;
import mz.org.csaude.muzimamobile.controller.MuzimaCohortExecutionStatusController;
import mz.org.csaude.muzimamobile.controller.MuzimaHTCFormController;
...
import mz.org.csaude.muzimamobile.controller.SmartCardController;
import mz.org.csaude.muzimamobile.domain.Credentials;
import mz.org.csaude.muzimamobile.service.FormDuplicateCheckPreferenceService;
import mz.org.csaude.muzimamobile.service.LocalePreferenceService;
import mz.org.csaude.muzimamobile.service.MuzimaGPSLocationService;
import mz.org.csaude.muzimamobile.service.MuzimaLoggerService;
import mz.org.csaude.muzimamobile.service.MuzimaSyncService;
import mz.org.csaude.muzimamobile.service.SntpService;
...
import mz.org.csaude.muzimamobile.view.forms.FormWebViewActivity;
import mz.org.csaude.muzimamobile.view.forms.HTMLFormWebViewActivity;
import mz.org.csaude.muzimamobile.view.preferences.MuzimaTimer;
...
import static mz.org.csaude.muzimamobile.utils.Constants.STATUS_COMPLETE;
import static mz.org.csaude.muzimamobile.utils.Constants.STATUS_INCOMPLETE;
import static mz.org.csaude.muzimamobile.view.preferences.MuzimaTimer.getTimer;
...
public class MuzimaApplication extends MultiDexApplication {
    ...
    private static final String APP_DIR = "/data/data/mz.org.csaude.muzimamobile";
    ...
    public void clearApplicationData() {
        try {
            ...
            if (dir.isDirectory()) {
                //throw new RuntimeException("Trying to delete application data");
                //deleteDir(dir);
            }

            muzimaContext.deleteDatabase();
            //MuzimaPreferences.getInstance(this).clear();
        } catch (Exception e) {
