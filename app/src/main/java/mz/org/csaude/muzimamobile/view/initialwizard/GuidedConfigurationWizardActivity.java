...
package mz.org.csaude.muzimamobile.view.initialwizard;
...
import mz.org.csaude.muzimamobile.adapters.ListAdapter;
import mz.org.csaude.muzimamobile.adapters.setupconfiguration.GuidedSetupActionLogAdapter;
import mz.org.csaude.muzimamobile.adapters.setupconfiguration.GuidedSetupCardsViewPagerAdapter;
...
import mz.org.csaude.muzimamobile.listners.IDialogListener;
import mz.org.csaude.muzimamobile.model.SetupActionLogModel;
import mz.org.csaude.muzimamobile.service.DefaultEncounterLocationPreferenceService;
...
import mz.org.csaude.muzimamobile.utils.Constants.DataSyncServiceConstants.SyncStatusConstants;
import mz.org.csaude.muzimamobile.utils.Constants.SetupLogConstants;
...
import mz.org.csaude.muzimamobile.utils.ViewUtil;
...
import mz.org.csaude.muzimamobile.view.login.ActiveConfigSelectionActivity;
...
public class GuidedConfigurationWizardActivity extends BroadcastListenerActivity implements ListAdapter.BackgroundListQueryTaskListener, IDialogListener {
    ...
    private boolean isIndexCaseProgram() {
       for (String setupConfigUuid : setupConfigTemplateUuidList) {
            if (setupConfigUuid.equals("83033fc8-34d2-45bf-94eb-074db2bd5ac7") || setupConfigUuid.equals("84f942a5-cb77-4949-bcd2-804c11d5c5a2")) return true;
        }
        return false;
    }
    ...
    private synchronized void evaluateFinishStatus() {
        ...
        if (!isAtsSetup() && !isIndexCaseProgram()) {
            TOTAL_WIZARD_STEPS = 13;
        }
    ...
    private void updateOnlineOnlyModeSettingValue(){
        ...
        } else if (!isIndexCaseProgram()) {
            mainProgressbar.setMax(13);
        }
        else {
