...
package mz.org.csaude.emuzima.adapters.media;
...
public class MediaRecyclerViewAdapter extends RecyclerView.Adapter<MediaRecyclerViewAdapter.ViewHolder> {
    ...
    private void startMediaDisplayActivity(Media media) {
        ...
        if(!file.exists()){
            ...
            String recentMedia = MuzimaPreferences.getStringPreference(context, context.getResources().getString(R.string.preference_recently_viewed_media), mz.org.csaude.emuzima.utils.StringUtils.EMPTY);
            if(!mz.org.csaude.emuzima.utils.StringUtils.isEmpty(recentMedia)) {
